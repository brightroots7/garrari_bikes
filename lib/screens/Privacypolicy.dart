                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 12),
                      Text(
                        'With due respect to the privacy of its users, the Garrari Bikes website abstains from getting personal information from users without their denotative consent. Garrari Bikes does not distribute, sell or rent any personal information collected via its website. This is also true for personal information (email address, postal address, etc.) sent to the website\'s email addresses and contact notes.',
                        style: TextStyle(fontSize: 16),
                      ),
                      SizedBox(height: 12),
                      Text(
